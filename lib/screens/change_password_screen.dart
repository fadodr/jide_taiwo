  ...
  Future<void> changepassword() async {
    ...
    try {
      if (option.toString().toLowerCase() == 'client') {
        ...
        await Provider.of<Agentprovider>(context, listen: false).changepassword(
            _oldPasswordController.text, _newPasswordcontroller1.text);
      }
      setState(() {
        isLoading = false;
          ...
          child: Form(
              ...
              child: SingleChildScrollView(
                child: Column(children: [
                  ...
                  _buildTextForm('Old password', _oldPasswordController,
                      _obscureOldPassword),
                  const SizedBox(
                    height: 15,
                  ),
                  _buildTextForm('New password', _newPasswordcontroller1,
                      _obscureNewPassword),
                  const SizedBox(
                    height: 15,
                  ),
                  _buildTextForm('Confirm password',
                      _newPasswordController2, _obscureConfirmPassword),
                  const SizedBox(
                    height: 50,
                  ),
                  isLoading
